...
public class TileMoreTileService0 extends TileService {

    private static final String TAG = "QSTILE0";
    ...
    private void updateTile() {
        if (Tile.STATE_ACTIVE == getQsTile().getState()) {
            Toast.makeText(TileMoreTileService0.this, "New State: INACTIVE", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(TileMoreTileService0.this, "New State: ACTIVE", Toast.LENGTH_SHORT).show();
    ...
    private void changeTileState(int newState) {
        getQsTile().setIcon(Icon.createWithResource(TileMoreTileService0.this, newState == Tile.STATE_INACTIVE ? R.drawable.tile_disabled : R.drawable.tile_enabled));
